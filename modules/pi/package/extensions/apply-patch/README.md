...
Local fork changes: atomic updates preserve the existing file permission bits, including executable mode. Absolute and parent-escaping paths are accepted, matching upstream behavior.
